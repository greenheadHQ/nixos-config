...
| Anki (headless) | `anki-host-backup` | 04:15 (`homeserver.ankiHost.backupTime`) | HDD (`/mnt/data/backups/anki-host/<instance>`, 인스턴스별 일일 `.colpkg`만; `backup.enable = false`인 검증용 `lab`은 제외. 복구점 `restore-points/`의 보존 계약은 plan 030 결정 11) |
