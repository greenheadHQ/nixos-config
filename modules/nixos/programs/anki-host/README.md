...
`plans/030-anki-mcp-host.md`에는 도입 이력과 미완료 운영 검증을 보존한다.
...
- 옛 **Anki Plugin Lab 등록 제거**와 MiniPC `lab` 데이터/서비스 폐기는 다른 작업이다. lab 삭제는 별도 승인 후 처리한다.
