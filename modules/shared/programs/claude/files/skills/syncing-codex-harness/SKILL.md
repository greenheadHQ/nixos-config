...
description: >-
  This skill should be used when the user needs to sync Claude Code harness
  to Codex CLI compatible format, projecting skills, agents, MCP servers,
  and rules into .agents/ and .codex/ directories.
